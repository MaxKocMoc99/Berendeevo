...
if (document.documentElement.clientWidth < 767) {
    const anotherTexts = document.querySelectorAll('.pictures__item__text__container')
    anotherTexts[1].insertAdjacentHTML('afterend', `
    <div class="pictures__item__text__container textcont-2">
  <div>Кристально чистые озера и густые леса </div>  
  <div>для многих отдыхающих являются диковинкой.</div>  
        <p class="text-down"><div>От души расслабиться, а заодно укрепить </div>
        <div> здоровье поможет русская баня на берегу озера.</div></p>
</div>`)
anotherTexts[2].insertAdjacentHTML('afterend', `
<div class="pictures__item__text__container textcont-2">
<div>Мы предлагаем вам разделить с нами ценности</div>
<div> нашего заповедника. Мы рады, что гости </div>
<div> возвращаются вновь и вновь на протяжении </div>
<div> многих лет.</div>
<p class="text-down"><div>Каждый сезон Берендеево старается удивить </div>
<div>посетителей чем-то новым и приятным.</div></p> 
</div>`)
    anotherTexts.forEach(text => text.style.display = 'none')
    anotherTexts[0].style.display = 'block'
} 