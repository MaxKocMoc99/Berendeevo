...
if (document.documentElement.clientWidth < 767) {
    ...
    anotherText.textContent = 'Отпразднуйте день рождения'
   ...
   <div>Имениннику предоставляется скидка 15%</div> 
   <div> на проживание в любом из номеров в течение</div> 
   <div> недели до/после даты дня рождения.</div> 
  </div>`)
  proposalTexts[1].insertAdjacentHTML('afterend', `
  <div class="proposal__text__text proposal__text__parahraph-2">
  <div>Скидка предоставляется при условии личного</div>
  <div>предоставления документов (паспорта</div>
  <div>или свидетельства о рождении) именинником</div>
  <div>при заезде.</div>
  </div>`)
  proposalTexts[2].insertAdjacentHTML('afterend', `
  <div class="proposal__text__text proposal__text__parahraph-3">
  <div>Узнать цены и забронировать коттедж можно </div>
  <div>по телефону: <b> +7 (8162) 50-22-99 </b></div>
  <div><span class="green"> Скидки и акции не суммируются</span></div>
  </div>`)
