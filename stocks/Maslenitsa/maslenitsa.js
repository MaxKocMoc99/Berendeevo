...
if (document.documentElement.clientWidth < 767) {
    ...
    anotherText.textContent = 'Масленица в Берендеево'
    ...
    <div>Предлагаем вам отпраздновать настоящий</div>
    <div>народный праздник – Масленица. Попрощайтесь</div>
    <div>с зимой и встретьте весну у нас</div>
    <div>в Берендеево Царство.</div>
    </div>`)
  proposalTexts[1].insertAdjacentHTML('afterend', `
  <div class="proposal__text__parahraph-3"><div>Узнать цены и забронировать коттедж можно
  </div>
  <div>По телефону:  +7 (8162) 50-22-99</div></div>`)
