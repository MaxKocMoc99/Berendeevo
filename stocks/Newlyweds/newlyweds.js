...
if (document.documentElement.clientWidth < 767) {
    ...
    anotherText.textContent = 'Специальное предложение'
    ...
    <div>При заказе кафе для празднования свадьбы </div>
    <div>– новобрачным ночь в подарок в 4-х местном</div>
    <div>номере или 10% скидка на размещение гостей.</div>
  </div>`)
  ...
  <div><span class="green">Скидки и акции не суммируются</span></div></div>`)
